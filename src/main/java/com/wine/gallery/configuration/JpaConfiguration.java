package com.wine.gallery.configuration;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.wine.gallery.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.wine.gallery.models" });
