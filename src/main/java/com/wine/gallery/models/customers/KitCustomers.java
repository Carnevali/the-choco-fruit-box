...
@Entity
@Table(name="kit_customers")
@JsonIgnoreProperties( ignoreUnknown = true )
public class KitCustomers implements Serializable {
    ...
    public KitCustomers(Customers customers, Chocolates chocolates) throws ValidationException {
        super();
